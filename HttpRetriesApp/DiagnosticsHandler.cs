...
namespace HttpClientApp
{
    ...
    {
        private readonly string diagnosticListenerName;
        ...
        public DiagnosticsHandler(HttpMessageHandler innerHandler, string  diagnosticListenerName) : base(innerHandler)
        {
            this.diagnosticListenerName = diagnosticListenerName;
        }
        ...
        internal static bool IsEnabled()
        {
            ...
            return IsGloballyEnabled() && (Activity.Current != null || Settings.s_originalDiagnosticListener.IsEnabled() || Settings.s_improvedDiagnosticListener.IsEnabled());
        }
            ...
            CancellationToken cancellationToken)
        {
            ...
            DiagnosticListener diagnosticListener = 
                this.diagnosticListenerName == Settings.s_originalDiagnosticListener.Name 
                    ? Settings.s_originalDiagnosticListener
                    : Settings.s_improvedDiagnosticListener;
        ...
        private static class Settings
        {
            ...
            */
            ...
            public static readonly DiagnosticListener s_originalDiagnosticListener =
                new DiagnosticListener(DiagnosticsHandlerLoggingStrings.OriginalDiagnosticListenerName);
            
            public static readonly DiagnosticListener s_improvedDiagnosticListener =
                new DiagnosticListener(DiagnosticsHandlerLoggingStrings.ImprovedDiagnosticListenerName);
        }
