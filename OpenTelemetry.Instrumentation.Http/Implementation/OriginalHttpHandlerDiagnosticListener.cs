...
{
    internal sealed class OriginalHttpHandlerDiagnosticListener : ListenerHandler
    {
        ...
        public OriginalHttpHandlerDiagnosticListener(HttpClientInstrumentationOptions options)
            : base("OriginalHttpHandlerDiagnosticListener")
        {
        ...
        public override void OnStartActivity(Activity activity, object payload)
        {
            ...
            {
                textMapPropagator.Inject(new PropagationContext(activity.Context, Baggage.Current), request, HttpRequestMessageContextPropagation.OriginalHeaderValueSetter);
            }
